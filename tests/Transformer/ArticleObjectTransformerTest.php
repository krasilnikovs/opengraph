...
use Krasilnikovs\Opengraph\Transformer\ArticleObjectTransformer;
use Krasilnikovs\Opengraph\Transformer\ObjectTransformerInterface;
use PHPUnit\Framework\Attributes\CoversClass;

#[CoversClass(ArticleObjectTransformer::class)]
final class ArticleObjectTransformerTest extends ObjectTransformerTestCase
{
    protected static function getTransformer(): ObjectTransformerInterface
    {
        return new ArticleObjectTransformer();
    }

    protected static function getObjectClass(): string
    {
        return ArticleObject::class;
    }
