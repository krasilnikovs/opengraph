...
use Krasilnikovs\Opengraph\Transformer\BookObjectTransformer;
use Krasilnikovs\Opengraph\Transformer\ObjectTransformerInterface;
use PHPUnit\Framework\Attributes\CoversClass;

#[CoversClass(BookObjectTransformer::class)]
final class BookObjectTransformerTest extends ObjectTransformerTestCase
{
    protected static function getTransformer(): ObjectTransformerInterface
    {
        return new BookObjectTransformer();
    }

    protected static function getObjectClass(): string
    {
        return BookObject::class;
    }
